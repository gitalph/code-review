...
// Для получения зачета требуется исправить несколько замечаний:
// переименовать файлы с данными
// добавить проверки на возможные ошибки при чтении этих файлов
// внимательно проверить выдаваемые API сообщения об ошибках
